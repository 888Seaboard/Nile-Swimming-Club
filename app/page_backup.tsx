...
// ❌ 不再使用 useScroll / useTransform，所以刪走 useSectionProgressValues
// ❌ 亦不再使用 sectionProgressValues
          ...
          <div className="relative pt-20 pb-16 sm:pb-24">
            <div className="text-center">
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-slate-900 dark:text-white">
                <span className="block">川河泳會 Nile Swimming Club</span>
                <span className="block text-primary dark:text-primary-light">
                  專業成人及兒童游泳課程
                </span>
              </h1>
              <p className="mt-6 max-w-2xl mx-auto text-lg text-slate-600 dark:text-slate-300">
                由持牌教練授課，提供初學、自救、一對一及比賽級訓練，適合 4 歲以上小朋友及成人。
              </p>

              <div className="mt-10 flex gap-4 justify-center">
                {/* 普通 button，無 framer-motion */}
                <button
